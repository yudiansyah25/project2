...
echo '<hr>';
echo '<h6>Ahmad Menabung Rp.1.000.000</h6>';
echo '<hr width=40%>';
$ab1->cetak();
$ab1->deposit(1000000);
echo '<br><h7>Setelah Menabung</h7>';
$ab1->cetak();
echo '<hr width=40%>';
echo '<h6>Ahmad Transfer ke Budi Rp.500.000 dan Kurniawan Rp.1.500.000</h6>';
$ab1->transfer($ab2,500000);
$ab1->transfer($ab3,1500000);
echo '*Biaya Transfer Rp.6.000';
echo '<br><h7>Sesudah transfer</h7>';
...
$ab3->cetak();
echo '<hr width=40%>';
echo '<h6>Budi Tarik Uang Rp.2.500.000</h6>';
$ab2->cetak();
$ab2->TarikUang(2500000);
echo '<br><h7>Sesudah Tarik Uang</h7>';
$ab2->cetak();
echo '<hr>';
